...
from PyQt5.QtWidgets import (QWidget, QLabel, QVBoxLayout, QHBoxLayout, QSpinBox, QApplication)
...
class ROISelector(QWidget):
    def __init__(self, parent=None):
        ...
        for i in range(4):
            ...
            self.roi_controls.append((self.x1_spin, self.y1_spin, self.x2_spin, self.y2_spin))
